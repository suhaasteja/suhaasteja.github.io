...
function initialize(data, dim1, dim2, reverse = true){
...
function updateData(data, dim1 = dimExpense, dim2 = dimOutcome, reverse = false){
	dimExpense = dim1, dimOutcome = dim2;
	x.domain(dimensions = d3.keys(data[0]).filter(function(d) {
		if (reverse) {
...
function handleMouseOut(d, i){
	...
	d3.selectAll("g.USA, g.JPN").style("opacity", 1);
}
